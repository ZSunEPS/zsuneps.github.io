...
In this simple case,<d-code language="html">x</d-code>is the independent variable (e.g., temperature, pressure, etc.) whose uncertainty is usually ignored due to precise experimental controls.<d-code language="html">y</d-code>is the dependent variable or observation, and its uncertainty is the measurement uncertainty (e.g., one standard error, 1SE, of multiple replicates of one sample).
